...
******************************************************/
#define LENGTH 4 //Length of lattice (as doible for angle types)
#define N 64 //LENGTH^3; number of spins/sites
...
#define WHERE_IS 1 //Where the program is while running
